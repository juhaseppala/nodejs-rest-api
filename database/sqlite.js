...
db.exec("CREATE TABLE IF NOT EXISTS events(id INTEGER PRIMARY KEY AUTOINCREMENT, event TEXT NOT NULL, location TEXT NOT NULL, event_date TEXT NOT NULL)STRICT")
